            ...
            <div className="auth-header">
              ...
              <div className="auth-textboxes">
                <If test={this.state.showField >= 0}>
                  <input className="auth-show-field" ref="email" type="text" placeholder="Enter your email..."/>
                </If>
              ...
              <If test={this.state.showField >= 3}>
                <button onClick={this.signUp} className="button-full auth-show-field">Sign up</button>
              </If>
            </div>
          </div>
          <div className="pure-u-8-24"></div>
